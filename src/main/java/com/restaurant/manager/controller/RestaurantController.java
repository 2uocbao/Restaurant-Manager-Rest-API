...
public class RestaurantController {
	...
	@PutMapping("/update")
	ResponseEntity<BaseResponse> updateRestaurant(@Valid @RequestParam(name = "id") int id,
	...
	@GetMapping("/detail")
	ResponseEntity<BaseResponse> detailRestaurant(@Valid @RequestParam(name = "id") int id) {
	...
	ResponseEntity<BaseResponse> changeStatusRestaurant(@Valid @RequestParam(name = "id") int id) {
		BaseResponse baseResponse = new BaseResponse();
